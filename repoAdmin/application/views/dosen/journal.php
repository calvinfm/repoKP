        ...
        <div class="content-wrapper">
          <div class="row" id="proBanner">
            <div class="col-12">
              <span class="d-flex align-items-center purchase-popup">
                ...
                <a href="<?=base_url('repoAdmin/admin/upload_journal')?>" target="_blank" class="btn btn-gradient-primary ml-auto btn-sm">Upload
                  Journal</a>
          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?=base_url('repoAdmin/admin/dashboard')?>">Dashboard</a></li>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <img src="<?=base_url('repoAdmin/assets/images/check.png')?>" class="img-fluid w-50 mx-auto d-block">
          ...
          <div class="modal fade" id="rejectedModalsJournal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <img src="<?=base_url('repoAdmin/assets/images/rejected.png')?>" class="img-fluid w-50 mx-auto d-block">
          ...
          <div class="modal fade" id="logOutModals" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <img src="<?=base_url('repoAdmin/assets/images/log_out.png')?>" class="img-fluid w-50 mx-auto d-block">
