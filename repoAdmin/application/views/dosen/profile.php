                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" runat="server">
                    <div class="text-center">
                      <img id="blah" src="<?=base_url('repoAdmin/assets/images/default.png')?>" alt="your image" class="rounded mx-auto d-block m-3 border border-secondary" style="max-width : 170px;" />
                    </div>
