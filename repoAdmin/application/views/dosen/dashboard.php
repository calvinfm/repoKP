          ...
          <div class="row" id="proBanner">
            <div class="col-12">
              <span class="d-flex align-items-center purchase-popup">
                ...
                <a href="<?=base_url('repoAdmin/admin/upload_journal')?>" target="_blank"
          ...
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                  <img src="<?=base_url('repoAdmin/assets/images/dashboard/circle.svg')?>" class="card-img-absolute" alt="circle-image" />
