<ul class="nav">
          <li class="nav-item nav-profile">
            <a href="" class="nav-link">
              <div class="nav-profile-image">
                <img src="<?=base_url('assets/images/admin.png')?>" alt="profile">
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              ...
              <a href="<?=base_url('admin/upload_journal')?>" class="btn btn-block btn-lg btn-gradient-primary mt-4 text-white"> +
                Upload
                Journal</a>
            </span>
          </li>
