            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    <h1 class="text-white mt-100">
                        BIAYA PRASYARAT PRODI S2 ILMU HUKUM
                    </h1>
                    <div class="link-nav">
                        <span class="box">
                            ...
                            <i class="lnr lnr-arrow-right"></i>
                            <a href="biaya-persyarat-prodi-s2-magister-hukum.html">Biaya Prasyarat Prodi S2 Ilmu Hukum</a>
                        </span>
                    </div>
                </div>
            </div>
...
echo "$mydate[weekday], $mydate[month] $mydate[mday], $mydate[year]"; ?></a> <span
                        ...
                        <div class="col-lg-9 col-md-9">
                            <h3 class="mt-20 mb-20">PROGRAM STUDI S2 ILMU HUKUM</h3>
                            <img src="<?= base_url('assets/img/IMG-20180809-WA0027.jpg')?>" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
